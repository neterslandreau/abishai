...
$html = '
    <table>
        <tr>
            <td style="width:30%"><h3>REFERRING PARTY/SELLER:</h3></td>
            <td style="border-bottom: 1px solid #000000;width:68%">Lennar</td>
        </tr>
        <tr>
            <td style="width:30%"><h3>CUSTOMER:</h3></td>
            <td style="border-bottom: 1px solid #000000;width:68%">Costomer Line</td>
        </tr>    
    </table>
...
';
		...
		return SPDF::loadHtml($html)->inline('github.pdf');
    }
}
